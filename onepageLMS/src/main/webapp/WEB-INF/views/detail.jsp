...
<div class="content">
  ...
  <div class="classBar" >
    <div style="font-size: 18px; line-height: 15px; height: 30%; overflow: auto; border-bottom: 3px solid black"> 
      <div style="padding: 10px; border-bottom: 3px solid black">
        ...
        <div style="float: right"> <a href="addclass">+</a> </div>
      </div>
  ...
  <div class="classContents">
	...
	<p>${u.startDate}</p>
	<p>active--> ${u.active}</p>
	<pre id='content' cols="200" rows="50" name="classContent" onkeydown="myFunction(event)">${u.classContent}</pre> <!-- 여기서는 편집이 안되게 해야하는디.. 수정하기 버튼을 누르면 그 때 편집될 수 있도록 해야하는디.. -->
	<button onclick="showToggle('content')">Try it</button>

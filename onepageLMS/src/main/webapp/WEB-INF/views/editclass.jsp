    ...
    <div style="font-size: 18px; line-height: 15px; height: 40%; overflow: auto; border-bottom: 3px solid black">
  	...
  	<form method="post" action="../editok">
		...
		<div id='content' class="content">
				...
				<textarea cols="200" rows="50" name="classContent" onkeydown="myFunction(event)">${u.classContent}</textarea>
		</div>
			
		<p>check box: <input type="checkbox" name="active" value="${u.active}"/></p>
